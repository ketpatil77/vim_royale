...
Before starting to contribute to this project, please familiarize yourself with the code architecture and design decisions by reading [ARCHITECTURE.md](ARCHITECTURE.md).
