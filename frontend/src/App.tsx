...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/play/difficulty" element={<DifficultySelect />} />
      <Route path="/play/computer" element={<ComputerSelect />} />
      <Route path="/play/minigames" element={<MiniGames />} />
      <Route path="/play/minigames/:gameId" element={<MiniGameArena />} />
      <Route
        path="/match/multiplayer"
        element={<MatchPage mode="multiplayer" />}
      />
      <Route path="/match/computer" element={<MatchPage mode="computer" />} />
      <Route path="/match/timed" element={<TimedMatchPage />} />
      <Route
      ...
      />
      <Route path="/t/:slug" element={<TournamentLobby />} />
      <Route path="/docs/vimtutor" element={<VimTutor />} />
      ...
      <Route path="/match/:matchId/replay" element={<MatchReplayPage />} />
      <Route path="/match/:matchId/live" element={<LiveSpectate />} />
...
function AppContent() {
  ...
  return (
    <CRTEffect
      theme="green"
      enableScanlines={crtEnabled}
      scanlineOpacity={0.1}
      scanlineThickness={2}
      scanlineGap={3}
      enableSweep={crtEnabled}
      sweepDuration={12}
      sweepThickness={8}
      sweepStyle="classic"
      enableGlow={false}
      enableEdgeGlow={true}
      edgeGlowColor="rgba(91, 179, 135, 0.25)"
      edgeGlowSize={25}
      enableFlicker={crtEnabled}
